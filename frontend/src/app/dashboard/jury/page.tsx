...
import { judgeApi, type SubmissionForJudge, ApiError } from "@/lib/api";
...
function ScorePanel({
    ...
    const scoreMutation = useMutation({
        mutationFn: async () => {
            ...
            return judgeApi.score({ submissionId: submission.id, score: s, comment: comment.trim() || undefined }, token);
        },
        onSuccess: () => {
            setSuccess(true);
            setOpen(false);
                ...
                <div className="border-t border-[#E0E0E0] bg-[#FAFAFA] p-6">
                    ...
                    <div className="flex gap-3 mt-4">
                        <button
                            ...
                            disabled={scoreMutation.isPending || !score}
